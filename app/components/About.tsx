...
export function About() {
  return (
    <section id="about" className="min-h-screen flex items-center justify-center px-4">
      <div className="pixel-frame p-8 max-w-4xl w-full">
        <h2 className="text-4xl mb-6 text-white text-center md:text-5xl">About Me</h2>
        <div className="pixel-text-box mb-8 p-6">
          <p className="text-white text-lg leading-relaxed text-center md:text-xl">
            Hi, I’m Tejaswi Mahadev—part machine learning engineer, part data detective, and full-time caffeine enthusiast. I specialize in turning messy datasets into meaningful insights, training AI models that (mostly) don’t hallucinate, and building intelligent systems that make life easier (or at least more interesting). My projects bridge the gap between innovation and real-world impact. When I’m not wrangling data, I’m leveling up in playing guitar, tinkering with new tech, or pretending I have a sleep schedule.
        ...
        <div className="flex flex-wrap justify-center space-x-4">
          ...
          <SocialIcon href="https://leetcode.com/u/TejaswiMahadev/" icon={<SiLeetcode />} />
          <SocialIcon href="https://developers.google.com/profile/u/TejaswiMahadev" icon={<FaMedal />} />
          <Link href="/Myresume.pdf" className="pixel-button p-2 mt-4 md:mt-0" download>
            Resume
          </Link>
        </div>
      </div>
...
function SocialIcon({ href, icon }: { href: string; icon: React.ReactNode }) {
  return (
    <Link href={href} className="pixel-button p-2 mb-4 md:mb-0" target="_blank" rel="noopener noreferrer">
      {icon}
    </Link>
  )
}
