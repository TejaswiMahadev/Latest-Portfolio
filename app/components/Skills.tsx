...
const blogs = [
  ...
  {name:"Forecasts with Foresight: The Retail Evolution Beyond Prediction",description:" A Framework for Counterfactual Forecasting and Retail Intervention Simulation",link:"https://medium.com/@tejaswimahadev9/forecasts-with-foresight-the-retail-evolution-beyond-prediction-f0c8c858b3f9"},
]
